        ...
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              ...
              <Text color={"gray.500"}>
                {about.role ? about.role : "Job title"}
              </Text>
            </VStack>
          </HStack>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "yourname@email.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "your phn no."}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Your Address"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {degree ? degree : "xyz degree"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {school ? school : "Cxyz School"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        <Text>
                          {startYr ? startYr : "Start Year"} -{" "}
                          {endYr ? endYr : "End Year"}
                        </Text>
